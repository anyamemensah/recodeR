...
2. A `from_col` column with the original (old) values for each variable/column.
3. A `to_col` column with the new values/labels that will replace the old ones for each variable/column.
